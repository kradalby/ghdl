...
in
assert check (lib.hasInfix "--hostname=ghdl" default)
  "default ExecStart missing --hostname: ${default}";
assert check (lib.hasInfix "--state-dir=/var/lib/ghdl" default)
  "default ExecStart missing --state-dir: ${default}";
assert check (lib.hasInfix "--hostname=dlmetrics" custom)
  "custom ExecStart missing overridden hostname: ${custom}";
assert check (lib.hasInfix "--github-repos=a/b,c/d" custom)
  "custom ExecStart missing joined repos: ${custom}";
